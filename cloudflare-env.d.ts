/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 5049d3da8e06339b349d19bf63a7b9f1)
// Runtime types generated with workerd@1.20260701.1 2026-04-17 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	TENANTS: KVNamespace;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	EVI_STATS: AnalyticsEngineDataset;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "PRISMIC_WEBHOOK_SECRET" | "CACHE_PURGE_ZONE_ID" | "CACHE_PURGE_API_TOKEN" | "TOKEN_MASTER_KEY">> {}
}
