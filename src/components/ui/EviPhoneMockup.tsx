...
/**
 * iPhone-inspireret ramme til app-screenshots. Alt i % / brøkdel af bredden så
 * proportioner holder ved scaling; indre radius = ydre − bezel → koncentriske
 * hjørner. Bredde via --evi-phone-w, så grupper kan skalere kompositionen 1-1.
 *
 * NB: globals.css opt'er `[data-slot="evi-phone-mockup"]` ud af global
 * corner-shape:squircle — ellers bliver kamera en squircle-firkant, ikke en cirkel.
 */
export function EviPhoneMockup({
  ...
  return (
    <div
      ...
      className={cn(
        // --frame-r/--frame-p = ydre radius + bezel som brøkdel af bredden (fluid).
    ...
    >
      ...
      {/* isolate = stacking context, så Next Image respekterer parent's
          overflow-hidden clip på rounded corners. bg = fallback bag LQIP-bluren. */}
      <div
